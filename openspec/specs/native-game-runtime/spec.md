# Native Game Runtime Specification

## Purpose

Define Cinderhell's packaged Woof runtime, isolated session boundary, Android lifecycle behavior, and supported native-engine scope.
