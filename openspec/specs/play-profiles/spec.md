# Play Profiles Specification

## Purpose

Define how Cinderhell composes games, ordered mods, curated settings, validation, Play, and Continue into durable launch profiles.
