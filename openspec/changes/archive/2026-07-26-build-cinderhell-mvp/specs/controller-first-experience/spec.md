...
Every primary launcher action SHALL be reachable with a directional pad or left stick, confirm button, and back button, with a visible and deterministic focus state.
